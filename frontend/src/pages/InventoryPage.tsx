      ...
      <div className="space-y-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button className="h-11 rounded-xl bg-emerald-600 px-5 hover:bg-emerald-700" onClick={() => setStockInOpen(true)}>
              <ArrowDownToLine size={16} />
              Nhập hàng
            </Button>
            <Button className="h-11 rounded-xl bg-pink-600 px-5 hover:bg-pink-700" onClick={() => setStockOutOpen(true)}>
              <ArrowUpToLine size={16} />
              Xuất hàng
            </Button>
            <Button className="h-11 rounded-xl bg-amber-500 px-5 hover:bg-amber-600" onClick={() => setAdjustmentOpen(true)}>
      ...
      <Dialog open={stockInOpen} onOpenChange={setStockInOpen}>
        <DialogContent className="max-w-3xl">
          ...
          <DialogFooter>
            ...
            <Button onClick={submitStockIn} disabled={!stockInForm.productId || !stockInForm.quantity || (stockInMaxAllowed !== null && stockInMaxAllowed <= 0)}>
              Xác nhận nhập hàng
            </Button>
          </DialogFooter>
        </DialogContent>
