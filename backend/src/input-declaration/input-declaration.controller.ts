...
export class InputDeclarationController {
  ...
  getAttributeUsages(
    ...
    const user = currentUser as unknown as UserPayload;
    this.checkPermission(user, 'view');
    const validTypes = ['classification', 'color', 'size', 'material', 'category', 'productCondition', 'storageZone', 'warehouseType'];
    if (!validTypes.includes(type)) {
      throw new BadRequestException('Loại khai báo không hợp lệ');
    }
    return this.inputDeclarationService.getDetailedAttributeUsages(type as any, id);
  }
  ...
  deleteCategory(
    ...
    return this.inputDeclarationService.deleteAttribute('category', id, force === 'true');
  }
  ...
  deleteClassification(
    ...
    const user = currentUser as unknown as UserPayload;
    this.checkPermission(user, 'delete');
    return this.inputDeclarationService.deleteAttribute('classification', id, force === 'true');
  }
  ...
  deleteColor(
    ...
    const user = currentUser as unknown as UserPayload;
    this.checkPermission(user, 'delete');
    return this.inputDeclarationService.deleteAttribute('color', id, force === 'true');
  }
  ...
  deleteSize(
    ...
    const user = currentUser as unknown as UserPayload;
    this.checkPermission(user, 'delete');
    return this.inputDeclarationService.deleteAttribute('size', id, force === 'true');
  }
  ...
  deleteMaterial(
    ...
    const user = currentUser as unknown as UserPayload;
    this.checkPermission(user, 'delete');
    return this.inputDeclarationService.deleteAttribute('material', id, force === 'true');
  }
  ...
  deleteProductCondition(
    ...
    const user = currentUser as unknown as UserPayload;
    this.checkPermission(user, 'delete');
    return this.inputDeclarationService.deleteAttribute('productCondition', id, force === 'true');
  }
  ...
  deleteWarehouseType(
    ...
    const user = currentUser as unknown as UserPayload;
    this.checkPermission(user, 'delete');
    return this.inputDeclarationService.deleteAttribute('warehouseType', id, force === 'true');
  }
  ...
  deleteStorageZone(
    ...
    const user = currentUser as unknown as UserPayload;
    this.checkPermission(user, 'delete');
    return this.inputDeclarationService.deleteAttribute('storageZone', id, force === 'true');
  }
  ...
  @Patch('sku-combos/batch-threshold')
  batchUpdateSkuComboThreshold(
    @CurrentUser() currentUser: Record<string, unknown>,
    @Body() dto: { items: Array<{ sku: string; minThreshold: number; maxThreshold: number }> },
  ) {
    const user = currentUser as unknown as UserPayload;
    this.checkPermission(user, 'edit');
    if (!dto.items || !Array.isArray(dto.items)) {
      throw new BadRequestException('items phải là một mảng');
    }
    return this.skuComboService.batchUpdateThreshold(dto.items);
  }
